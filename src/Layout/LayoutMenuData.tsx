...
const Navdata = () => {
    ...
    const menuItems: any = [
            ...
            subItems: [
                {
                    ...
                    link: "/teams-member-list",
                    parentId: "products",
                },
                {
                    id: "createteammember",
                    label: "Create Team Member",
                    link: "/teams-member-add",
                    parentId: "products",
                },
            ],
        },
        ...
        {
            id: "projects-and-families",
            label: "Projects & Families",
            icon: "bi bi-archive",
            link: "/#",
            click: function (e: any) {
                e.preventDefault();
            ...
            subItems: [
                {
                    id: "clientsandfamiliesdashboard",
                    label: "Clients & Families Page",
                    link: "/projects-and-families",
                    parentId: "clients-and-families",
                },
            ],
        },
        {
